...
function ConfirmOrder() {
  ...
  const { cart, submit, totalPrice } = useCart();
  ...
  return (
    <article className="flex flex-col gap-400">
      <header>
        <svg
          width="48"
          height="48"
        ...
        <h2 className="text-preset-1 mb-100 font-bold text-rose-900">
          Order Confirmed
        </h2>
        <p className="text-base font-normal text-rose-500">
